...
def handle_support_message(message):
    ...
    # Формируем сообщение для пользователя (без отправки администраторам)
    support_msg = f"""
📩 <b>Ваше сообщение принято:</b>

{message_text}

⏰ <b>Время отправки:</b> {datetime.now().strftime('%d.%m.%Y %H:%M')}
"""
...
# УДАЛЕНО: обработчик check_user_payment_handler для раздела "💎 Донат"
